...
Do NOT decompose \u2014 this is already summarized.`;
    var MANUAL_ENTITY_CONTEXT2 = `This is user-curated content EXPLICITLY saved by the developer.
...
- Standard tool usage without learning value`;
    ...
    module2.exports = {
      ...
      MANUAL_ENTITY_CONTEXT: MANUAL_ENTITY_CONTEXT2,
...
// src/add-memory.js
var { MemoryStackClientWrapper, MANUAL_ENTITY_CONTEXT } = require_memorystack_client();
var { loadSettings, getApiKey, getProjectName } = require_settings();
async function main() {
