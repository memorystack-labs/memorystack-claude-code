---
description: Index codebase into MemoryStack for persistent context
allowed-tools: ["Read", "Glob", "Grep", "Bash", "Task"]
---

# Codebase Indexing

Explore this codebase deeply and compile findings into MemoryStack.
...
## Final Step: Save to MemoryStack

After exploring all phases, compile everything into one comprehensive summary and save:

```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/save-project-memory.cjs" "YOUR COMPILED FINDINGS HERE"
```
